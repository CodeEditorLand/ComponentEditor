const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["_astro/Action.B9xJAraf.js","_astro/preload-helper.BelkbqnE.js","_astro/dev.SL9eOBoj.js","_astro/Editor.DagS4su0.js","_astro/editor.main.DRixcDvy.js","_astro/editor.Cwh6TVrJ.css","_astro/Editor.Bhs7m739.css"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from './preload-helper.BelkbqnE.js';
import { t as template, c as createComponent, i as insert, S as Suspense, l as lazy } from './dev.SL9eOBoj.js';
let w;
let __tla = (async ()=>{
    ...
    const $ = lazy(()=>__vitePreload(()=>import('./Action.B9xJAraf.js').then(async (m)=>{
                await m.__tla;
                return m;
            }), true ? __vite__mapDeps([0,1,2]) : void 0)), s = lazy(()=>__vitePreload(()=>import('./Editor.DagS4su0.js'), true ? __vite__mapDeps([3,2,4,1,5,6]) : void 0));
