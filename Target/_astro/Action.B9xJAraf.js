const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["_astro/editor.main.DRixcDvy.js","_astro/preload-helper.BelkbqnE.js","_astro/editor.Cwh6TVrJ.css","_astro/Context.BogJZp_I.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from './preload-helper.BelkbqnE.js';
import { t as template, c as createComponent } from './dev.SL9eOBoj.js';
let r, o, m, p;
let __tla = (async ()=>{
    ...
    ({ _Function: o } = await __vitePreload(()=>import('./Context.BogJZp_I.js').then(async (m)=>{
            await m.__tla;
            return m;
